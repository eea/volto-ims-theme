...
const NotFound = () => (
  <Container className="view-wrapper">
    ...
    <p>
      <FormattedMessage
        id="If you are certain you have the correct web address but are encountering an error, please {contact_us}."
        defaultMessage="If you are certain you have the correct web address but are encountering an error, please {contact_us}."
        values={{
          contact_us: (
            <Link to="/contact-us">
              <FormattedMessage
